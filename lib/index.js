var convert,
  ...
  measures = {
    ...
    stiffness: require('./definitions/stiffness'),
    torsionalDamping: require('./definitions/torsionalDamping'),
    torsionalStiffness: require('./definitions/torsionalStiffness'),
    torquePressureRatio: require('./definitions/torquePressureRatio'),
    pressureForceRatio: require('./definitions/pressureForceRatio'),
    specificEnergy: require('./definitions/specificEnergy'),
    brakeSpecificFuelConsumption: require('./definitions/brakeSpecificFuelConsumption'),
    airwayConductance: require('./definitions/airwayConductance'),
    capacitance: require('./definitions/capacitance'),
    damping: require('./definitions/damping'),
    fluidDensity: require('./definitions/fluidDensity'),
